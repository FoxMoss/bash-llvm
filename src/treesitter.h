...
std::unordered_map<std::string, std::string> query_to_theme = {
    {
        "punctuation.bracket",
        "overlay2",
    },
...
std::unordered_map<std::string, std::string> catppuccin_mocha_theme = {
...
// from
// https://github.com/nvim-treesitter/nvim-treesitter/blob/4916d6592ede8c07973490d9322f187e07dfefac/runtime/queries/bash/highlights.scm
// Apache Licensed
static const std::string highlighter_query =
    R"p([
  "("
  ")"
  "{"
